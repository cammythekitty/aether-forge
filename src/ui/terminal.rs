...
const RUNES: &str = "ᚠ  ᚢ  ᚦ  ᚨ  ᚱ  ᚷ";
const BRAND: &str = "Æ T H E R  F O R G E";
...
impl Terminal {
    ...
    pub fn awake(&self) {
        println!("  {} {}", "⟁".bright_cyan(), "Æther Forge is awake.".bold().bright_white());
        println!();
    }

    pub fn forging(&self) {
        println!("  {} {}", "⟁".bright_cyan(), "Forging...".dimmed());
    }
